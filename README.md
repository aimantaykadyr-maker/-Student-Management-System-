...
-“Least Recently Used” алгоритмі арқылы деректерді ығыстыру симуляциясы. -AI-оқытушы:
...
-Frontend: React.js, Tailwind CSS (Cyberpunk стиль) -Logic: JavaScript (LRU алгоритм) -AI Integration: Google AI Studio (Gemini API) -Deployment: Google Cloud
...
<img width="581" height="418" alt="image" src="https://github.com/user-attachments/assets/0852f158-e855-4a53-bb48-c8da16165ac2" />
